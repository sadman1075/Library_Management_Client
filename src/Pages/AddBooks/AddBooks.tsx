...
export function AddBooks({
    ...
    const handleBooks = async (e) => {
        ...
        if (response.data) {
            Swal.fire({
                title: "Good job!",
                text: "You have successfully added the book!",
                icon: "success"
            });
                ...
                <div className={cn("flex flex-col gap-6", className)} {...props}>
                    <Card className="overflow-hidden p-0">
                        <CardContent className="grid p-0 md:grid-cols-2">
                            <form className="p-6 md:p-8" onSubmit={handleBooks}>
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid shrink-0 grid-cols-1 focus-within:relative">
                                            <select id="currency" name="Availability" aria-label="Currency" className="col-start-1 row-start-1 w-full appearance-none rounded-md py-1.5 pr-7 pl-3 text-base border-2 text-gray-500 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" required>
